...
consumer = KafkaConsumer(KAFKA_TOPIC, bootstrap_servers=KAFKA_BROKER, group_id='my-group')
        ...
        try:
            ...
            if len(values) == 6:
                ...
                try:
                    ...
                    cursor.execute(insert_statement, (timestamp, open, high, low, close, volume))
                    conn.commit()
